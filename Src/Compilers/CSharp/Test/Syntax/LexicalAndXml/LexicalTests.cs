...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public class LexicalTests
    {
        ...
        public void TestSingleLineComment()
        {
            ...
            Assert.Equal(SyntaxKind.EndOfFileToken, token.CSharpKind());
            ...
            Assert.Equal(SyntaxKind.SingleLineCommentTrivia, trivia[0].CSharpKind());
        }
        ...
        public void TestSingleLineDocCommentFollowedBySlash()
        {
            ...
            Assert.Equal(SyntaxKind.SingleLineCommentTrivia, trivia.CSharpKind());
        ...
        public void TestMultiLineCommentOnOneLine()
        {
            ...
            Assert.Equal(1, trivia.Length);
            Assert.NotNull(trivia[0]);
            Assert.Equal(SyntaxKind.MultiLineCommentTrivia, trivia[0].CSharpKind());
        }
...
**/";
            ...
            Assert.Equal(1, trivia.Length);
            Assert.NotNull(trivia[0]);
            Assert.Equal(SyntaxKind.MultiLineDocumentationCommentTrivia, trivia[0].CSharpKind());
        }
        ...
        public void TestAllLanguageKeywords()
        {
            foreach (var keyword in SyntaxFacts.GetKeywordKinds())
            {
                if (SyntaxFacts.IsReservedKeyword(keyword))
                {
                    ...
                    Assert.NotNull(token);
                    Assert.True(SyntaxFacts.IsReservedKeyword(token.CSharpKind()));
                    Assert.Equal(text, token.Text);
                    var errors = token.Errors();
                    Assert.Equal(0, errors.Length);
                    Assert.Equal(text, token.ValueText);
        ...
        public void TestStringLiteral()
        {
            ...
            Assert.NotNull(token);
            Assert.Equal(SyntaxKind.StringLiteralToken, token.CSharpKind());
            Assert.Equal(text, token.Text);
            var errors = token.Errors();
            Assert.Equal(0, errors.Length);
        ...
        public void TestCharacterLiteral()
        {
            ...
            Assert.NotNull(token);
            Assert.Equal(SyntaxKind.CharacterLiteralToken, token.CSharpKind());
            Assert.Equal(text, token.Text);
            var errors = token.Errors();
            Assert.Equal(0, errors.Length);
            Assert.Equal(value, token.ValueText);
        ...
        [Fact]
        [Trait("Feature", "Literals")]
        public void TestNumericOctalLiteral()
        {
            var value = 83;
            var text = "0o123";
            var token = LexToken(text);
        ...
        [Fact]
        [Trait("Feature", "Literals")]
        public void TestNumericOctalLiteralWithUnsignedAndLongSpecifier()
        {
            var value = 83ul;
            var text = "0o123ul";
            var token = LexToken(text);
        ...
        [Fact]
        [Trait("Feature", "Literals")]
        public void TestNumericOctalLiteralWithUpperUnsignedAndLongSpecifier()
        {
            var value = 83Ul;
            var text = "0o123Ul";
            var token = LexToken(text);
        ...
        [Fact]
        [Trait("Feature", "Literals")]
        public void TestNumericOctalLiteralWithUnsignedAndUpperLongSpecifier()
        {
            var value = 83uL;
            var text = "0o123uL";
            var token = LexToken(text);
        ...
        [Fact]
        [Trait("Feature", "Literals")]
        public void TestNumericOctalLiteralWithUpperUnsignedAndUpperLongSpecifier()
        {
            var value = 83UL;
            var text = "0o123UL";
            var token = LexToken(text);
        ...
        public void TestDebuggerCompilerGeneratedIdentifiers()
        {
            ...
            Assert.NotNull(token);
            Assert.Equal(SyntaxKind.LessThanToken, token.CSharpKind());
            Assert.Equal(0, errors.Length);
            Assert.Equal("<", token.Text);
            ...
            Assert.NotNull(token);
            Assert.Equal(SyntaxKind.LessThanLessThanToken, token.CSharpKind());
            Assert.Equal(0, errors.Length);
            Assert.Equal("<<", token.Text);
        }
        ...
        public void TestWhitespace()
        {
            ...
            Assert.Equal(SyntaxKind.WhitespaceTrivia, leading[0].CSharpKind());
            ...
            Assert.Equal(SyntaxKind.WhitespaceTrivia, trailing[0].CSharpKind());
